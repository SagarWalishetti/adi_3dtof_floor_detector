 ...
 *
 */
void ADI3DToFFloorDetector::readInputAbort()
{
...
void ADI3DToFFloorDetector::updateDynamicReconfigureVariablesInputThread()
{
  if (ab_threshold_ != dynamic_reconfigure_config_.ab_threshold)
  {
    ...
    ROS_INFO("Dynamic Reconfigure: Modified the 'ab_threshold' parameter %d", ab_threshold_);
  ...
  if (confidence_threshold_ != dynamic_reconfigure_config_.confidence_threshold)
  {
    ...
    ROS_INFO("Dynamic Reconfigure: Modified the 'confidence_threshold' parameter %d", confidence_threshold_);
